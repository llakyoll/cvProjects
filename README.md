...
| [restroom-usage-alert](./restroom-usage-alert) | Counts doorway entries and prints an alarm when a configured threshold is reached | YOLO, OpenCV | ![demo](./restroom-usage-alert/assets/output.gif) |
| [license-plate-ocr](./license-plate-ocr) | Detects and reads license plates from images and streams | YOLOv11, FastPlateOCR, OpenCV | — |
